...
# # Load your TensorBoard event file
# event_path = '/local/home/hanwliu/lab_record/train_splatfacto/fvs_120/splatfacto/2025-05-01_104228'
# event_acc = EventAccumulator(event_path)
# event_acc.Reload()

# # List all available tags (scalars, images, etc.)
# print(event_acc.Tags()['scalars'])

# # Get PSNR scalar values
# psnr_events = event_acc.Scalars('Eval Images Metrics Dict (all images)/psnr')

# # Extract final PSNR
# final_psnr = psnr_events[-1].value
...
#     selected_tags = {m: tag_map[m] for m in metrics}
...
#     event_files,
#     metrics=['lpips'],  # or just ['lpips'] 'ssim'
#     tight_ylim=False
# )
plot_tensorboard_by_training_views(
