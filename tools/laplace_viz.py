...
eigvals_fvs     = np.load("/local/home/hanwliu/activevision/eigenvalues_fvs_gcd_[5, 30].npy")
eigvals_vlm     = np.load("/local/home/hanwliu/activevision/eigenvalues_vlm_gcd_[5, 30].npy")
eigvals_fvsvlm  = np.load("/local/home/hanwliu/activevision/eigenvalues_fvs_vlm_gcd_[5, 30].npy")
