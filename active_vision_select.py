...
def parse_args():
    ...
    parser.add_argument("--dist_type", default="euc",
                        choices=["euc", "gcd"],
                        help="Distance metric for FVS: euc (Euclidean), gcd (Great Circle Distance)")
    parser.add_argument("--vlm_dist_type", default="cos",
                        choices=["euc", "cos"],
    ...
    parser.add_argument("--all_transform", default="", type=str,
...
def copy_new_images_with_order(all_train_transform, new_indices,
                               round_idx, dst_dir, base_dir):
    """
